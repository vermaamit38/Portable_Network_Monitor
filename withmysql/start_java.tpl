...
<div class="panel panel-primary">
       <div class="panel-heading">Show each user page request</div>
       <div class="panel-body">Please Click Here  <button type="button" class="btn btn-default btn-sm" onclick="myfunction5()" >Click</button></div>
     </div>
...
<br>
	...
	<script language="javascript">
        ...
        function myfunction()
	{     
		window.open("button4_java.tpl");
	}
        function myfunction1()
	{     
		window.open("button3.tpl");
	}
        function myfunction2()
	{     
		window.open("button2_java.tpl");
	}
	
        function myfunction3()
	{     
		window.open("button4.tpl");
	}
         function myfunction4()
	{     
		window.open("button5.tpl");
	}
 function myfunction5()
	{     
		window.open("button_page.tpl");
	}
        </script>
